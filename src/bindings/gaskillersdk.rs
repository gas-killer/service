...
pub mod GasKillerSDK {
    ...
    ///Container for all the [`GasKillerSDK`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[allow(clippy::large_enum_variant)]
    pub enum GasKillerSDKCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for GasKillerSDKCalls {
        const NAME: &'static str = "GasKillerSDKCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<GasKillerSDKCalls>] = &[
                {
                    fn blsSignatureChecker(
                        ...
                        .map(GasKillerSDKCalls::blsSignatureChecker)
                    }
                    blsSignatureChecker
                },
                {
                    fn QUORUM_THRESHOLD(
                        ...
                        .map(GasKillerSDKCalls::QUORUM_THRESHOLD)
                    }
                    QUORUM_THRESHOLD
                },
                {
                    fn BLOCK_STALE_MEASURE(
                        ...
                        .map(GasKillerSDKCalls::BLOCK_STALE_MEASURE)
                    }
                    BLOCK_STALE_MEASURE
                },
                {
                    fn namespace(
                        ...
                        <namespaceCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(GasKillerSDKCalls::namespace)
                    }
                    namespace
                },
                {
                    fn verifyAndUpdate(
                        ...
                        .map(GasKillerSDKCalls::verifyAndUpdate)
                    }
                    verifyAndUpdate
                },
                {
                    fn avsAddress(
                        ...
                        <avsAddressCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(GasKillerSDKCalls::avsAddress)
                    }
                    avsAddress
                },
                {
                    fn THRESHOLD_DENOMINATOR(
                        ...
                        .map(GasKillerSDKCalls::THRESHOLD_DENOMINATOR)
                    }
                ...
                },
                {
                    fn stateTransitionCount(
                        ...
                        .map(GasKillerSDKCalls::stateTransitionCount)
                    }
    ...
    ///Container for all the [`GasKillerSDK`](self) custom errors.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum GasKillerSDKErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for GasKillerSDKErrors {
        const NAME: &'static str = "GasKillerSDKErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<GasKillerSDKErrors>] = &[
                {
                    fn FutureBlockNumber(
                        ...
                        .map(GasKillerSDKErrors::FutureBlockNumber)
                    }
                    FutureBlockNumber
                },
                {
                    fn StaleBlockNumber(
                        ...
                        .map(GasKillerSDKErrors::StaleBlockNumber)
                    }
                    StaleBlockNumber
                },
                {
                    fn InvalidOperation(
                        ...
                        .map(GasKillerSDKErrors::InvalidOperation)
                    }
                    InvalidOperation
                },
                {
                    fn RevertingContext(
                        ...
                        .map(GasKillerSDKErrors::RevertingContext)
                    }
                    RevertingContext
                },
                {
                    fn InvalidArguments(
                        ...
                        .map(GasKillerSDKErrors::InvalidArguments)
                    }
                    InvalidArguments
                },
                {
                    fn InsufficientQuorumThreshold(
                        ...
                        .map(GasKillerSDKErrors::InsufficientQuorumThreshold)
                    }
                ...
                },
                {
                    fn InvalidTransitionIndex(
                        ...
                        .map(GasKillerSDKErrors::InvalidTransitionIndex)
                    }
                ...
                },
                {
                    fn InvalidSignature(
                        ...
                        .map(GasKillerSDKErrors::InvalidSignature)
                    }
                    InvalidSignature
                },
                {
                    fn InvalidStorageUpdates(
                        ...
                        .map(GasKillerSDKErrors::InvalidStorageUpdates)
                    }
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`GasKillerSDK`](self) contract instance.

    See the [wrapper's documentation](`GasKillerSDKInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> GasKillerSDKInstance<T, P, N> {
        GasKillerSDKInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<GasKillerSDKInstance<T, P, N>>>
    {
        GasKillerSDKInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        GasKillerSDKInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`GasKillerSDK`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`GasKillerSDK`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct GasKillerSDKInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for GasKillerSDKInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("GasKillerSDKInstance")
                .field(&self.address)
                .finish()
        }
    }
    ...
    > GasKillerSDKInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<GasKillerSDKInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> GasKillerSDKInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> GasKillerSDKInstance<T, P, N> {
            GasKillerSDKInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
