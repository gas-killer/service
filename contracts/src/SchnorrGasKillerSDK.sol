...
} from "./interface/ISchnorrGasKillerSDKBatch.sol";
    ...
    ISchnorrGasKillerSDKBatch
{
    ...
    bytes32 private constant STORAGE_LOCATION =
        0x1d6f9f139320a34a32f3b29eb8638270178e831962a74100c9e8b433f21e1200;
    ...
    function verifyAndUpdateBatch(SchnorrTaskSubmission[] calldata submissions)
        external
        guardTransition
    {
    ...
    function _verifyAndUpdateOne(
        ...
        require(
            (uint256(referenceBlockNumber) + _getBlockStaleMeasure()) >= block.number, StaleBlockNumber()
        );
    ...
    function _verifyQuorum(
        ...
        bool ok =
            _sto().registry.isValidSignature(msgHash, s, Raddr, nonSigners, referenceBlockNumber);
    ...
    function inTransition()
        public
        view
        override(TransitionGuard, ISchnorrGasKillerSDKBatch)
        returns (bool locked)
    {
