...
import {SchnorrGasKillerSDK} from "../src/SchnorrGasKillerSDK.sol";
...
contract SchnorrGasKillerSDKTest is Test {
    ...
    function test_verifyAndUpdate_revertsOnBadHash() public {
        ...
        sdk.verifyAndUpdate(bytes32(uint256(1)), uint32(block.number - 1), updates, ti, bytes4(0), 1, address(0x1), none);
    }
