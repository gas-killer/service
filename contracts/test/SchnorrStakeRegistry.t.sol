...
contract SchnorrStakeRegistryTest is Test {
    ...
    function test_gas_benchmark() public view {
        ...
        console2.log("For comparison (ECDSA, from service #311 benches):");
        console2.log("  ECDSAStakeRegistry base    3 ops: 65027 ; +15581/op");
        console2.log("  ECDSAStakeRegistry cached  3 ops: 30825 ; +6700/op");
        // The Schnorr verify is constant in the number of *signers* (one ecrecover); cost
        // grows only with the number of *non-signers*, which is ~0 at healthy participation.
        assertLt(gasFull, 30825, "full-participation Schnorr must beat cached ECDSA 3-op");
    }
}
