...
//!
//! Mirror of [`crate::submitter::Submitter`] over the schnorr coordinator's
//! [`SchnorrCertified`] observations instead of the reporter's ECDSA
...
impl SchnorrSubmitter {
    ...
    async fn handle_certified(&mut self, certified: SchnorrCertified) {
        ...
        // the ECDSA submitter — transient RPC errors recover, deterministic
